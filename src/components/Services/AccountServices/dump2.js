...
export const calculateTaxAsync = createAsyncThunk(
  ...
  taxExemptItems = {
    ...
    // Deduct tax-exempt items from the chargeable income
 // Deduct tax-exempt items from the chargeable income
taxableIncome -= taxExemptItems.nationalHousingFund || 0;
taxableIncome -= taxExemptItems.nationalHealthInsurance || 0;
taxableIncome -= taxExemptItems.lifeAssurancePremium || 0;
taxableIncome -= taxExemptItems.nationalPensionScheme || 0;
